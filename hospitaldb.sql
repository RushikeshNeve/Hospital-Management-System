...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2022 at 09:05 AM
...
INSERT INTO `appointment` (`appointmentid`, `patientname`, `departmentname`, `doctorname`, `appointmentdate`, `appointmenttime`, `phone`, `email`, `message`, `status`) VALUES
(29, 'Sahil Sunil Kamdar', 'Gynecology', 'Sahil Sunil Kamdar', '2022-06-16', '22:24:00', 'sahilkamdar.ssk1@gmail.com', '7418529630', 'qwertyuiop', 'Inactive'),
(30, 'Prasad Chavan', 'Maternity', 'Logan Fletcher', '2022-06-23', '21:25:00', 'Prasad@gmail.com', '7418529630', 'esrdtfygh', 'Inactive'),
(31, 'Bhushan', 'Haematology', 'Ben Bernier', '2022-06-15', '20:25:00', 'Bhushan@gmail.com', '7539148620', 'yhbdcujnd', 'Inactive'),
(32, 'madhurmundada0', 'Cardiology', 'Sahil Sunil Kamdar', '2022-06-15', '17:56:00', 'sudarshanpande929@gmail.com', '7539148620', 'qwertyui', 'Inactive');
...
INSERT INTO `billing` (`billingid`, `patientname`, `billingdate`, `billingtime`, `taxamount`, `discharge_time`, `discharge_date`) VALUES
(1, 'Bhushan', '2019-06-15', '18:53:38', 0.00, '00:00:00', '0000-00-00'),
(2, '1', '2019-06-15', '19:56:20', 0.00, '00:00:00', '0000-00-00'),
(3, '3', '2021-06-24', '14:39:11', 0.00, '07:56:26', '2021-06-24'),
(4, '5', '2021-06-24', '18:48:00', 0.00, '07:26:39', '2021-06-24'),
(5, '6', '2021-06-24', '19:36:12', 0.00, '07:54:07', '2021-06-24');
...
INSERT INTO `doctor` (`doctorid`, `doctorname`, `mobileno`, `departmentname`, `status`, `education`, `experience`, `consultancy_charge`, `gender`, `start_time`, `end_time`) VALUES
(8, 'Ben Bernier', '7012225470', 'Nephrology', 'Active', 'DM', '3.0', '689.00', 'Male', '10:00', '19:00'),
(10, 'Prasad Chavan', '7418529630', 'Medicine', 'Active', 'MBBS', '8', '600', 'Male', '13:00', '18:00'),
(14, 'Bhushan', '7545424465', 'Medicine', 'Active', 'BAMS', '10', '900', 'Male', '09:00', '17:00'),
(15, 'Aman Tejwani', '9578645321', 'Nephrology', 'Active', 'BHMS', '8', '500', 'Male', '14:00', '20:00'),
(16, 'Kedar', '8754968525', 'Haematology', 'Active', 'BAMS', '6', '300', 'Male', '10:00', '17:00'),
(17, 'Anshul', '9785987569', 'Oncology', 'Active', 'BAMS', '8', '400', 'Male', '13:00', '22:00'),
(18, 'madhur mundada', '7854968547', 'Maternity', 'Active', 'MBBS', '8', '600', 'Male', '12:00', '21:00'),
(20, 'Deepti', '7418529630', 'Radiology', 'Active', 'MBBS', '10', '600', 'Female', '10:00', '20:00'),
(21, 'Prashant', '7896445876', 'Oncology', 'Active', 'MBBS', '9', '1000', 'Male', '09:00', '18:00');
...
INSERT INTO `login` (`userid`, `loginname`, `password`) VALUES
(1, 'admin', '1234'),
(2, 'sahil', '12345');
...
CREATE TABLE `patient` (
  ...
  `admissiontime` time NOT NULL DEFAULT current_timestamp(),
  `address` text NOT NULL,
  `mobileno` text NOT NULL,
  `city` text NOT NULL,
...
INSERT INTO `patient` (`patientid`, `email`, `patientname`, `admissiondate`, `admissiontime`, `address`, `mobileno`, `city`, `pincode`, `illness`, `bloodgroup`, `gender`, `age`) VALUES
(32, 'sudarshanpande929@gmail.com', 'ghjn', '2022-06-11', '16:58:48', 'qwertyuiopasdfghjklzxcvbnm', '7249724902', 'Latur', '413512', 'Cough', 'B-', 'Male', '20'),
(33, 'kshitij@gmail.com', 'kshitij', '2022-06-11', '18:33:32', 'qwertyuiopzsxdfghjk', '7418529630', 'Karad', '411005', 'Cold', 'O+', 'Male', '20'),
(34, 'Neve@gmail.com', 'Rushikesh Neve', '2022-06-13', '12:41:13', 'qwertyuiopasdfghjkzxcvbnm', '7521456575', 'Karad', '456552', 'Brain Tumor', 'AB-', 'Male', '22'),
(35, 'Prasad@gmail.com', 'Prasad Chavan', '2022-06-13', '17:20:23', 'qwertyuiopzsxdfghjk', '7418529630', 'Latur', '413512', 'Brain Tumor', 'B-', 'Male', '20');
...
--
ALTER TABLE `appointment`
  MODIFY `appointmentid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `doctor`
  MODIFY `doctorid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `patient`
  MODIFY `patientid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
